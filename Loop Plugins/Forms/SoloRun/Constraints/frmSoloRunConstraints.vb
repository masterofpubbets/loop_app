...
Public Class frmSoloRunConstraints
    Private solo As New SolorunSteps
    ...
    Private Sub GetFolder()
        saveColumnsWidth()
        grd.DataSource = solo.getConstraints
        formatColumnsWidth()
        ...
        gv.Columns("FolderID").Visible = False
    ...
    Private Sub BarButtonItem3_ItemClick(sender As Object, e As DevExpress.XtraBars.ItemClickEventArgs) Handles BarButtonItem3.ItemClick
        ...
        For Each row_handle As Integer In gv.GetSelectedRows
            ...
            If gv.GetDataRow(row_handle).Item("Issued To") = Users.userFullName Then
                If solo.closeBlockage(gv.GetDataRow(row_handle).Item("ID")) Then
                End If
            ...
            ElseIf InStr(Users.userType, "admin", CompareMethod.Text) > 0 Then
                ...
                End If
            Else
                result &= "Only the responsible or the admin can close the blockage for this Folder: " & gv.GetDataRow(row_handle).Item("Folder Name") & vbCrLf
            End If
        ...
        End If
        msgR = MsgBox(String.Format("Folder Have Been Updated {0} Do You Want To Refresh ?", vbCrLf), MsgBoxStyle.YesNo, Me.Text)
        If msgR = MsgBoxResult.No Then Exit Sub
        GetFolder()
    End Sub
        ...
        If frm.selectedUserName <> "" Then
            ...
            For Each row_handle As Integer In gv.GetSelectedRows
                ...
                ElseIf instr(Users.userType, "admin", CompareMethod.Text) > 0 Then
                    ...
                    End If
                Else
                    result &= "Only the responsible or the admin can reassign responsible for this Folder: " & gv.GetDataRow(row_handle).Item("Folder Name") & vbCrLf
                End If
    ...
    Private Sub BarButtonItem7_ItemClick(sender As Object, e As DevExpress.XtraBars.ItemClickEventArgs) Handles BarButtonItem7.ItemClick
        ...
        For Each row_handle As Integer In gv.GetSelectedRows
            ''close blockage here
            If gv.GetDataRow(row_handle).Item("Issued To") = Users.userFullName Then
                If solo.addComment(gv.GetDataRow(row_handle).Item("Id"), frmComment.Comment) Then
                End If
            ElseIf Users.userType = "admin" Then
                If solo.addComment(gv.GetDataRow(row_handle).Item("Id"), frmComment.Comment) Then
                End If
            Else
                result &= "Only the responsible or the admin can add comment for this Folder: " & gv.GetDataRow(row_handle).Item("Folder Name") & vbCrLf
            End If
        ...
        If result <> "" Then
            ...
            frmErr.ShowDialog(Me)
        End If
        msgR = MsgBox(String.Format("Folders Have Been Updated {0} Do You Want To Refresh ?", vbCrLf), MsgBoxStyle.YesNo, Me.Text)
        If msgR = MsgBoxResult.No Then Exit Sub
        GetFolder()
    End Sub
    ...
    Private Sub BarButtonItem8_ItemClick(sender As Object, e As DevExpress.XtraBars.ItemClickEventArgs) Handles BarButtonItem8.ItemClick
        ...
        For Each row_handle As Integer In gv.GetSelectedRows
            ''close blockage here
            If gv.GetDataRow(row_handle).Item("Issued To") = Users.userFullName Then
                If solo.removeComment(gv.GetDataRow(row_handle).Item("ID")) Then
                End If
            ElseIf instr(Users.userType, "admin", CompareMethod.Text) > 0 Then
                If solo.removeComment(gv.GetDataRow(row_handle).Item("ID")) Then
                End If
            Else
                result &= "Only the responsible or the admin can remove comment for this loop: " & gv.GetDataRow(row_handle).Item("Folder Name") & vbCrLf
            End If
