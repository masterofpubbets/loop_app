...
Public Class frmEquipment
    ...
    Private Sub BarButtonItem11_ItemClick(sender As Object, e As DevExpress.XtraBars.ItemClickEventArgs) Handles BarButtonItem11.ItemClick
        ...
        Dim act As New Activities
        For Each row_handle As Integer In gv.GetSelectedRows
            act.UpdateActIds(Activities.Discipline.Equipment, Activities.Keys.Erect, gv.GetDataRow(row_handle).Item("Tag"), "")
        Next
        getData()
    End Sub
    ...
    Private Sub BarButtonItem16_ItemClick(sender As Object, e As DevExpress.XtraBars.ItemClickEventArgs) Handles BarButtonItem16.ItemClick
        ...
        If frm.isUpdated Then
            Dim act As New Activities
            For Each row_handle As Integer In gv.GetSelectedRows
                act.UpdateTeam(Activities.Discipline.Equipment, gv.GetDataRow(row_handle).Item("Tag"), frm.newValye)
            Next
            msgR = MsgBox(String.Format("Equipment Have Been Updated {0} Do You Want To Refresh?", vbCrLf), MsgBoxStyle.YesNo, Me.Text)
            If msgR = MsgBoxResult.No Then Exit Sub
            getData()
    ...
    Private Sub BarButtonItem17_ItemClick(sender As Object, e As DevExpress.XtraBars.ItemClickEventArgs) Handles BarButtonItem17.ItemClick
        ...
        Dim groupId As ResourcesMan.GROUPID = ResourcesMan.GROUPID.UniversalEquipment
        ...
        If frm.IsSelected Then
            For Each row_handle As Integer In gv.GetSelectedRows
                For inx As Integer = 1 To frm.ResId.Count
                    Dim unused = res.Assign(frm.ResId.Item(inx), gv.GetDataRow(row_handle).Item("Id"), ResourcesMan.GROUPID.UniversalEquipment)
                Next
            Next
    ...
    Private Sub BarButtonItem19_ItemClick(sender As Object, e As DevExpress.XtraBars.ItemClickEventArgs) Handles BarButtonItem19.ItemClick
        Dim msgR As MsgBoxResult = MsgBox(String.Format("Do You Want To Clear All Resources For All {0}{1} Selected Equipment?", vbCrLf, gv.GetSelectedRows.Count), MsgBoxStyle.YesNo, Me.Text)
        If msgR = MsgBoxResult.No Then Exit Sub
        Dim res As ResourcesManItem, itemId As Integer = 0, groupId As ResourcesManItem.GROUPID = ResourcesMan.GROUPID.UniversalEquipment
        For Each row_handle As Integer In gv.GetSelectedRows
