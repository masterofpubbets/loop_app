...
Public Class frmUpdateBoxupFolders
    Private sheet As New DevExpressUserSpreadSheet
    Private lf As New Boxups
    Private prepared As Boolean = False
    Const SHEETNAME = "BoxUp"
    Private boxupFolders As List(Of Boxup) = Nothing
    Private IsAddNew As Boolean = False
    Private DisabledConfirmation As Boolean = False

    Public Sub New(Optional folders As List(Of Boxup) = Nothing, Optional bhIsAddNew As Boolean = False)

        ' This call is required by the designer.
        InitializeComponent()

        boxupFolders = folders
        IsAddNew = bhIsAddNew
        If IsAddNew Then
    ...
    Private Sub prepareSheets()
        ...
        If Not IsAddNew Then
            If Not IsNothing(boxupFolders) Then
                Dim rInx As Integer = 1
                For Each lf As Boxup In boxupFolders
