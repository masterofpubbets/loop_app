...
Public Class frmBoxupManagement
    ...
    Private BoxupsLists As New Boxups
    ...
    Private Sub SaveChanges()
        ...
        frmd.grdPred.DataSource = BoxupsLists.GetFoldersForPlanning
        frmd.Text = "Box Up Folders Data Changes"
        frmd.ShowDialog(Me)
    ...
    Private Sub BarButtonItem9_ItemClick(sender As Object, e As DevExpress.XtraBars.ItemClickEventArgs) Handles BarButtonItem9.ItemClick
        Application.DoEvents()
        Dim folders As New List(Of Boxup)
        For Each row_handle As Integer In gv.GetSelectedRows
            folders.Add(New Boxup(
        ...
        Dim frm As New frmUpdateBoxupFolders(folders)
        frmMain.AddToQuickAccess(frm)
        frm.MdiParent = frmMain
        frm.Show()
    End Sub
