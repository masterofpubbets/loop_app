...
Partial Class frmPdf
    ...
    Private Sub InitializeComponent()
        ...
        'opnFle
        '
        Me.opnFle.FileName = "OpenFileDialog1"
        Me.opnFle.Filter = "PDF Files|*.pdf"
        '
        'PdfBarController1
        '
