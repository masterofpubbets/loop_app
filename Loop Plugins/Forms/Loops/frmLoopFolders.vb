...
Public Class frmLoopFolders
    ...
    Private Sub GetLoopHCSTasks()
        ...
        End Try
    End Sub
    Private Sub GetLoopHCSPendingTasks()
        Try
            Dim gNames As New List(Of String)
            For Each row_handle As Integer In gv.GetSelectedRows
                gNames.Add(gv.GetDataRow(row_handle).Item("Loop Name"))
    ...
    Private Sub UpdateLoopReturnFromQC()
        ...
        End Try
    End Sub
    Private Sub UpdateConstTargetDate()
        Try
            ...
            If frm.IsSelect Then
                ...
                For Each row_handle As Integer In gv.GetSelectedRows
                    ...
                    loopList.Add(New LoopFolder(
                                 ...
                                 "",
                                 "",
                                 frm.SelectedDate,    'Const Target Date
    ...
    Private Sub BarButtonItem1_ItemClick_1(sender As Object, e As DevExpress.XtraBars.ItemClickEventArgs) Handles BarButtonItem1.ItemClick
        ...
        For Each row_handle As Integer In gv.GetSelectedRows
            If inx = 0 Then
                _filter = "[Loop Name] LIKE '" & gv.GetDataRow(row_handle).Item("Loop Name") & "'"
            Else
                _filter &= " OR [Loop Name] LIKE '" & gv.GetDataRow(row_handle).Item("Loop Name") & "'"
            End If
            inx += 1
        Next
        gv.Columns("Loop Name").FilterInfo = New ColumnFilterInfo(_filter)
    End Sub
    ...
    Private Sub BarButtonItem2_ItemClick_1(sender As Object, e As DevExpress.XtraBars.ItemClickEventArgs) Handles rMenuShare.ItemClick
        ...
        If frm.isSelected Then
            ...
            For Each row_handle As Integer In gv.GetSelectedRows
                ...
                inx += 1
            Next
            Notifications.PushMappedNotification(Users.userFullName, frm.selectedUserId, "Loop Folder", frm.description, Replace(_filter, "'", "''",,, CompareMethod.Text))
    ...
    Private Sub rMenuSetFolderConsTargetDate_ItemClick(sender As Object, e As DevExpress.XtraBars.ItemClickEventArgs) Handles rMenuSetFolderConsTargetDate.ItemClick
        UpdateConstTargetDate()
    End Sub
End Class