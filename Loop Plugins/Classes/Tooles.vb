...
#Region "Data Methods" '
            ...
            Public Sub ExportDataGridData(ByRef grd As DataGridView, ByVal SaveedExcelPath As String, ByVal SheetName As String)
                Try
                    ...
                    x.FormateRange(Color.FromArgb(75, 130, 199), Color.White, 9, True, 25, Microsoft.Office.Interop.Excel.XlHAlign.xlHAlignCenter, Microsoft.Office.Interop.Excel.XlHAlign.xlHAlignLeft)
                    x.CellBorder(Color.White, 2)
                    x.SetRange("A2", grd.Rows.Count + 1, grd.Columns.Count)
                    x.FormateRange(Color.White, Color.Black, 9, True, 25, Microsoft.Office.Interop.Excel.XlHAlign.xlHAlignCenter, Microsoft.Office.Interop.Excel.XlHAlign.xlHAlignLeft)
...
KeyFound:
    ...
    Namespace MSOffice
        Public Class Excel
            Public Event Err(ByVal msg As String)
            Public Function IfSheetExists(ByVal WorkbookPath As String, ByVal SHeetname As String) As Boolean
                Dim objA As New Microsoft.Office.Interop.Excel.Application
                Dim xlWorkBook As Microsoft.Office.Interop.Excel._Workbook = objA.Workbooks.Open(WorkbookPath)
                Dim xs As Microsoft.Office.Interop.Excel._Worksheet
                objA.Visible = False
            ...
            Public Function GetSheetData(ByVal WorkBookPath As String, ByVal SheetName As String, Optional filter As String = "") As DataTable
                ...
                Try
                    ...
                    If filter = "" Then
                        Q = String.Format("select * from [{0}$]", SheetName)
                    Else
                        Q = String.Format("select * from [{0}$] where " & filter, SheetName)
                    End If
    ...
    Namespace FilesSystem
        Public Class FileSearch
            ...
            End Sub
            Public Function IsContainsWord(ByVal Keyword As String, ByVal Filepath As String) As Boolean
                Dim obj As New System.IO.StreamReader(Filepath)
                Try
                    Dim sql As String = ""
                    If InStr(obj.ReadToEnd, Keyword, CompareMethod.Text) > 0 Then
                        obj.Close()
                        Return True
                    End If
                Catch ex As Exception
