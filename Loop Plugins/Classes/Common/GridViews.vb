...
Public Class GridViews
    ...
    Public Overloads Function ApplyViewLayout(ByRef grdView As DevExpress.XtraGrid.Views.Grid.GridView, ByVal fileName As String) As Boolean
        ...
        Return False
    End Function
    Public Overloads Function ApplyViewLayout(ByRef gntView As DevExpress.XtraGantt.GanttControl, ByVal fileName As String) As Boolean
        If IO.File.Exists(fileName) Then
            Try
                gntView.OptionsLayout.StoreAllOptions = True
                gntView.OptionsLayout.StoreAllOptions = True
                gntView.OptionsLayout.StoreAppearance = True
                gntView.RestoreLayoutFromXml(fileName)
                Return True
            Catch ex As Exception
                Return False
            End Try
    ...
    Public Overloads Function SaveViewLayout(ByRef grdView As DevExpress.XtraGrid.Views.Grid.GridView, ByVal viewName As String) As Boolean
        ...
        Return False
    End Function
    Public Overloads Function SaveViewLayout(ByRef gntView As DevExpress.XtraGantt.GanttControl, ByVal viewName As String) As Boolean
        Try
            If IO.File.Exists(viewName) Then IO.File.Delete(viewName)
            gntView.OptionsLayout.StoreAllOptions = True
            gntView.OptionsLayout.StoreAllOptions = True
            gntView.OptionsLayout.StoreAppearance = True
            gntView.SaveLayoutToXml(viewName)
    ...
    Public Overloads Function CopySelectedItems(ByRef grdView As DevExpress.XtraGrid.Views.Grid.GridView, ByVal columnName As String) As Boolean
        Try
